...
export function buildIntentRoutingPrompt(surface: 'workspace' | 'slack'): string {
  ...
  return [
    ...
    '',
    'Mission filter: every reply should push shipping or revenue (tickets, status, Cursor handoff, CS/pipeline/CRM, Mem0). Skip fluff.',
    ...
    '   Triggers: status questions, summaries, lists, "what is…", "show me…", "how many…", pipeline/CS questions, casual ops chat.',
    ...
    '   Behavior: Answer in this thread using tools. Prefer the next concrete action (ticket, status, handoff, lookup). Do NOT call tasks_start_goal or tasks_start_slice.',
    '',
