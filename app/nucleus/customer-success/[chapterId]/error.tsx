  ...
  return (
    <div className="error-page">
      <div className="error-page-card">
        ...
        <h1 className="error-page-title">Chapter failed to load</h1>
        <p className="error-page-message">
          {error.message || 'An unexpected error occurred loading this chapter.'}
        </p>
        {error.digest && (
        ...
        <div className="error-page-actions">
          ...
          <a className="error-page-btn-secondary" href="/nucleus/customer-success">
            <ArrowLeft size={15} />
