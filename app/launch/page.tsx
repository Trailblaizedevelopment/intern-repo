    ...
    return (
      <div style={{ background: 'white', minHeight: '100vh', fontFamily: 'Inter, system-ui, sans-serif', display: 'flex', flexDirection: 'column' }}>
        ...
        >
          ...
          {/* ── Sub-step 5: Dual CTA ── */}
          {subStep === 5 && (
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', minHeight: 'calc(100vh - 210px)' }}>
              <div style={{ maxWidth: '520px', width: '100%', textAlign: 'center' }}>
                <h2 style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', fontWeight: 700, color: '#111827', margin: '0 0 8px', letterSpacing: '-0.01em' }}>
                  Ready to activate your network?
                </h2>
                <p style={{ fontSize: '1rem', color: '#6B7280', margin: '0 0 36px', lineHeight: 1.65 }}>
                  Choose your path.
                </p>

                {/* Option 1: Claim your org */}
                <button
                  onClick={() => { setSubStep(6); advanceSubStep(); }}
                  style={{
                    width: '100%', padding: '20px 24px', borderRadius: 12,
                    background: '#0F172A', color: 'white', border: 'none', cursor: 'pointer',
                    fontFamily: 'inherit', textAlign: 'left', marginBottom: 16,
                    display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                  }}
                >
                  <div>
                    <div style={{ fontSize: '1.0625rem', fontWeight: 700, marginBottom: 4 }}>
                      Ready to claim your org&apos;s Space?
                    </div>
                    <div style={{ fontSize: '0.8125rem', color: '#94A3B8', fontWeight: 400 }}>
                      Takes about 5 minutes to set up. We handle the rest.
                    </div>
                  </div>
                  <ArrowRight size={20} style={{ flexShrink: 0, marginLeft: 12 }} />
                </button>
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: '0.8125rem', color: '#6B7280', fontWeight: 400 }}>
                      Launching this May. Be first to get access.
                    </div>
                  </div>
                  <ArrowRight size={20} style={{ flexShrink: 0, marginLeft: 12, color: '#9CA3AF' }} />
                </button>
              </div>
            </div>
          )}
